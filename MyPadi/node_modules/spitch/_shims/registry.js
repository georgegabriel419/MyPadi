...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'spitch/shims/${shims.kind}'\` before importing anything else from spitch`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'spitch/shims/${shims.kind}'\` after \`import 'spitch/shims/${exports.kind}'\``);
    }
